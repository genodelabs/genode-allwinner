...
#ifndef _SRC__DRIVERS__PLATFORM__A64__A64_DEVICE_H_
#define _SRC__DRIVERS__PLATFORM__A64__A64_DEVICE_H_
...
class Driver::A64_device : public Driver::Device
{
	public:
		...
		A64_device(Device::Name name, Device::Type type)
		: Device(name, type) {}
...
: Genode::List_model<A64_device::Clock>::Update_policy
{
...
: Genode::List_model<A64_device::Power_domain>::Update_policy
{
	Genode::Allocator & alloc;
...
: Genode::List_model<A64_device::Reset_domain>::Update_policy
{
	Genode::Allocator & alloc;
...
#endif /* _SRC__DRIVERS__PLATFORM__A64__A64_DEVICE_H_ */
